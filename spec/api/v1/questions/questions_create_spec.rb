  ...
  describe 'POST /api/v1/questions' do
    context 'with valid params ' do
      ...
      it 'creates question links' do
        expect { post api_path, params: request_params, headers: headers }.to change(Link, :count).by(2)
      end
    end
    context 'with invalid params ' do
      ...
      it 'does NOT creates invalid question' do
        expect { post api_path, params: request_params, headers: headers }.to_not change(Question, :count)
      end
